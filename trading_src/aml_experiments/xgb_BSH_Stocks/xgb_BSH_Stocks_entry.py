...
estimator = Estimator(source_directory="trading_src",
              ...
              entry_script='aml_experiments/xgb_BSH_Stocks/xgb_BSH_Stocks_script.py')

# Create an experiment
experiment = Experiment(workspace = ws, name = 'xgb-BSH-training-stocks')
...
# Register the model
run.register_model(model_path='outputs/xgb-BSH-training-stocks.pkl', model_name='xgb-BSH-training-stocks',
